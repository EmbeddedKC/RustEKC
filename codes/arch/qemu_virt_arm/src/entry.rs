...
unsafe fn init_boot_page_table() {
    ...
    BOOT_PT_L0[0] = PageTableEntry::new_table(VirtAddr::new(0).into());
    
    BOOT_PT_L0[1] = PageTableEntry::new_table(VirtAddr::new(BOOT_PT_L1.as_ptr() as usize).into());
